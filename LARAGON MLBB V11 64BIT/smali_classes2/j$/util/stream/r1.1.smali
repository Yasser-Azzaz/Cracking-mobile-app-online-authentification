...
.field protected final b:Lj$/util/stream/w0;
...
# direct methods
.method constructor <init>(ILj$/util/S;Lj$/util/stream/w0;)V
    .locals 0

    invoke-direct {p0}, Ljava/util/concurrent/CountedCompleter;-><init>()V

    iput-object p2, p0, Lj$/util/stream/r1;->a:Lj$/util/S;

    iput-object p3, p0, Lj$/util/stream/r1;->b:Lj$/util/stream/w0;
    ...
    iput-wide p2, p0, Lj$/util/stream/r1;->c:J

    const-wide/16 p2, 0x0

    iput-wide p2, p0, Lj$/util/stream/r1;->d:J
...
.method constructor <init>(Lj$/util/stream/r1;Lj$/util/S;JJI)V
    .locals 3
    ...
    iget-object p2, p1, Lj$/util/stream/r1;->b:Lj$/util/stream/w0;

    iput-object p2, p0, Lj$/util/stream/r1;->b:Lj$/util/stream/w0;
...
# virtual methods
.method abstract a(Lj$/util/S;JJ)Lj$/util/stream/r1;
.end method
...
.method public final compute()V
    ...
    iget-object v6, p0, Lj$/util/stream/r1;->a:Lj$/util/S;
    ...
    iget-wide v2, v7, Lj$/util/stream/r1;->c:J
    ...
    iget-wide v2, v7, Lj$/util/stream/r1;->d:J

    move-object v0, v7

    move-wide v4, v8

    invoke-virtual/range {v0 .. v5}, Lj$/util/stream/r1;->a(Lj$/util/S;JJ)Lj$/util/stream/r1;

    move-result-object v0

    invoke-virtual {v0}, Ljava/util/concurrent/ForkJoinTask;->fork()Ljava/util/concurrent/ForkJoinTask;

    iget-wide v0, v7, Lj$/util/stream/r1;->d:J

    add-long v2, v0, v8

    iget-wide v0, v7, Lj$/util/stream/r1;->e:J
    ...
    :cond_0
    iget-object v0, v7, Lj$/util/stream/r1;->b:Lj$/util/stream/w0;

    invoke-virtual {v0, v6, v7}, Lj$/util/stream/w0;->y1(Lj$/util/S;Lj$/util/stream/h2;)Lj$/util/stream/h2;
...
.method public final g(J)V
    ...
    iput p2, p0, Lj$/util/stream/r1;->f:I

    long-to-int p1, v0

    add-int/2addr p2, p1

    iput p2, p0, Lj$/util/stream/r1;->g:I
