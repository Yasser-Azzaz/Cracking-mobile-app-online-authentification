...
.method constructor <init>(Lj$/util/stream/c;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/l2;->s:J

    iput-wide p5, p0, Lj$/util/stream/l2;->t:J
...
.method static T1(Lj$/util/I;JJJ)Lj$/util/I;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/x3;-><init>(Lj$/util/I;JJ)V
...
.method final J1(Lj$/util/S;Lj$/util/function/N;Lj$/util/stream/c;)Lj$/util/stream/F0;
    ...
    iget-wide v4, v9, Lj$/util/stream/l2;->s:J

    iget-wide v7, v9, Lj$/util/stream/l2;->t:J
    ...
    invoke-static {v6, v0, v10}, Lj$/util/stream/w0;->U0(Lj$/util/stream/w0;Lj$/util/S;Z)Lj$/util/stream/C0;
    ...
    iget-wide v1, v9, Lj$/util/stream/l2;->s:J

    iget-wide v3, v9, Lj$/util/stream/l2;->t:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/l2;->T1(Lj$/util/I;JJJ)Lj$/util/I;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/w0;->U0(Lj$/util/stream/w0;Lj$/util/S;Z)Lj$/util/stream/C0;
    ...
    iget-wide v7, v9, Lj$/util/stream/l2;->s:J

    iget-wide v11, v9, Lj$/util/stream/l2;->t:J
...
.method final K1(Lj$/util/stream/c;Lj$/util/S;)Lj$/util/S;
    ...
    iget-wide v9, p0, Lj$/util/stream/l2;->s:J

    iget-wide p1, p0, Lj$/util/stream/l2;->t:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/q3;-><init>(Lj$/util/I;JJ)V
    ...
    iget-wide v1, p0, Lj$/util/stream/l2;->s:J

    iget-wide v3, p0, Lj$/util/stream/l2;->t:J
    ...
    iget-wide v5, p0, Lj$/util/stream/l2;->s:J

    iget-wide v7, p0, Lj$/util/stream/l2;->t:J
...
.method final M1(ILj$/util/stream/h2;)Lj$/util/stream/h2;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/k2;-><init>(Lj$/util/stream/l2;Lj$/util/stream/h2;)V
