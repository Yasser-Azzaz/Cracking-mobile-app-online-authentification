...
.method constructor <init>(Lj$/util/S;JJJJ)V
    ...
    iput-object p1, p0, Lj$/util/stream/v3;->c:Lj$/util/S;
...
.method protected abstract e(Lj$/util/S;JJJJ)Lj$/util/S;
.end method
...
.method public bridge synthetic trySplit()Lj$/util/F;
    ...
    invoke-virtual {p0}, Lj$/util/stream/v3;->trySplit()Lj$/util/S;
...
.method public final trySplit()Lj$/util/S;
    ...
    :cond_0
    iget-wide v3, p0, Lj$/util/stream/v3;->d:J
    ...
    iget-wide v0, p0, Lj$/util/stream/v3;->a:J

    cmp-long v3, v0, v11

    if-ltz v3, :cond_3

    iput-wide v11, p0, Lj$/util/stream/v3;->d:J

    goto :goto_0

    :cond_3
    iget-wide v7, p0, Lj$/util/stream/v3;->b:J

    cmp-long v3, v11, v7

    if-ltz v3, :cond_4

    iput-object v4, p0, Lj$/util/stream/v3;->c:Lj$/util/S;

    iput-wide v11, p0, Lj$/util/stream/v3;->e:J

    goto :goto_0

    :cond_4
    iget-wide v9, p0, Lj$/util/stream/v3;->d:J
    ...
    invoke-virtual/range {v3 .. v12}, Lj$/util/stream/v3;->e(Lj$/util/S;JJJJ)Lj$/util/S;
