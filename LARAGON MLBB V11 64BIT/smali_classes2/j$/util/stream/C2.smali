...
.method constructor <init>(Lj$/util/stream/c;)V
    ...
    invoke-direct {p0, p1, v0}, Lj$/util/stream/X1;-><init>(Lj$/util/stream/c;I)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lj$/util/stream/C2;->s:Z

    invoke-static {}, Lj$/util/a;->z()Ljava/util/Comparator;

    move-result-object p1

    iput-object p1, p0, Lj$/util/stream/C2;->t:Ljava/util/Comparator;
...
.method constructor <init>(Lj$/util/stream/c;Ljava/util/Comparator;)V
    ...
    .line 0
    iput-object p2, p0, Lj$/util/stream/C2;->t:Ljava/util/Comparator;
...
.method public final J1(Lj$/util/S;Lj$/util/function/N;Lj$/util/stream/c;)Lj$/util/stream/F0;
    ...
    iget-boolean v0, p0, Lj$/util/stream/C2;->s:Z
    ...
    invoke-interface {p1, p2}, Lj$/util/stream/F0;->s(Lj$/util/function/N;)[Ljava/lang/Object;

    move-result-object p1

    iget-object p2, p0, Lj$/util/stream/C2;->t:Ljava/util/Comparator;
    ...
    invoke-direct {p2, p1}, Lj$/util/stream/I0;-><init>([Ljava/lang/Object;)V
...
.method public final M1(ILj$/util/stream/h2;)Lj$/util/stream/h2;
    ...
    iget-object v0, p0, Lj$/util/stream/C2;->t:Ljava/util/Comparator;

    if-eqz p1, :cond_1

    new-instance p1, Lj$/util/stream/H2;

    invoke-direct {p1, p2, v0}, Lj$/util/stream/H2;-><init>(Lj$/util/stream/h2;Ljava/util/Comparator;)V
    ...
    invoke-direct {p1, p2, v0}, Lj$/util/stream/D2;-><init>(Lj$/util/stream/h2;Ljava/util/Comparator;)V
